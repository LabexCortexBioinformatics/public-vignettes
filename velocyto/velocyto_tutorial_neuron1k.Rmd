...
velocyto run10x -@ 32 --samtools-memory 2048 /mnt/Data1/training_guillaume/cellranger_output/51_G_A /opt/cellranger/transcriptome/refdata-gex-GRCh38-2020-A/genes/genes.gtf
```
...
velocyto run10x -@ 32 --samtools-memory 2048 /mnt/Data1/public_vignettes/cellranger_output/neuron_1k/ /opt/cellranger/transcriptome/refdata-gex-mm10-2020-A/genes/genes.gtf; shutdown -h now
```
